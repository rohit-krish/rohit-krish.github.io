...
![depiction of the steps of getting gaussian kernel matrix from it’s 1D plot](assets/posts/gaussian/image1-dark.jpg){: .dark}
![depiction of the steps of getting gaussian kernel matrix from it’s 1D plot](assets/posts/gaussian/image1-light.jpg){: .light}
...
![using box filter v/s gaussian filter](assets/posts/gaussian/image2-dark.jpg){: .dark}
![using box filter v/s gaussian filter](assets/posts/gaussian/image2-light.jpg){: .light}
...
![animation of how the convolution operation is performed](assets/posts/gaussian/image3-light.gif){: .light}
